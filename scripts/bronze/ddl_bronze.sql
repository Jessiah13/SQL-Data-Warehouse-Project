...
Script Purpose: 
	This scrip creates all the tables we need for our project and sets the 
	name data types for each field in the 'bornze' schema.

WARNING:
	Running this script will drop all tables if exists in the bronze schema 
